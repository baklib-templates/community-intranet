(() => {
  ...
  // ns-hugo:C:\dev\products\aircontrol\themes\aircontrol\assets\js\components\resizeChild.js
  var require_resizeChild = __commonJS({
    "ns-hugo:C:\\dev\\products\\aircontrol\\themes\\aircontrol\\assets\\js\\components\\resizeChild.js"(exports, module) {
      !function(c) {
        if (typeof window != "undefined") {
          var i = true, o = 10, r = "", a = 0, u = "", s = null, d = "", l = false, f = { resize: 1, click: 1 }, m = 128, h = true, g = 1, n = "bodyOffset", p = n, v = true, y = "", w = {}, b = 32, T = null, E = false, O = false, S = "[iFrameSizer]", M = S.length, I = "", N = { max: 1, min: 1, bodyScroll: 1, documentElementScroll: 1 }, A = "child", C = true, z = window.parent, k = "*", R = 0, x = false, e = null, L = 16, F = 1, t = "scroll", P = t, D = window, j = function() {
          ...
          te(window, "message", function(t2) {
            ...
            function e2() {
              var e3 = o2();
              e3 in n2 ? n2[e3]() : (typeof module == "undefined" || !module.exports) && "iFrameResize" in window || "jQuery" in window && "iFrameResize" in window.jQuery.prototype || r2() || re("Unexpected message (" + t2.data + ")");
            }
            S === ("" + t2.data).substr(0, M) && (h === false ? e2() : r2() ? n2.init() : ie('Ignored message of type "' + o2() + '". Received before initialization.'));
        ...
        function ie(e2) {
          E && typeof window.console == "object" && console.log(oe(e2));
        }
        function re(e2) {
          typeof window.console == "object" && console.warn(oe(e2));
        }
        function ae() {
          function e2(e3) {
            return e3 === "true";
          ...
          t2 = y.substr(M).split(":"), I = t2[0], a = c !== t2[1] ? Number(t2[1]) : a, l = c !== t2[2] ? e2(t2[2]) : l, E = c !== t2[3] ? e2(t2[3]) : E, b = c !== t2[4] ? Number(t2[4]) : b, i = c !== t2[6] ? e2(t2[6]) : i, u = t2[7], p = c !== t2[8] ? t2[8] : p, r = t2[9], d = t2[10], R = c !== t2[11] ? Number(t2[11]) : R, w.enable = c !== t2[12] && e2(t2[12]), A = c !== t2[13] ? t2[13] : A, P = c !== t2[14] ? t2[14] : P, O = c !== t2[15] ? Boolean(t2[15]) : O, ie("Initialising iFrame (" + window.location.href + ")"), function() {
            function e3(e4, t3) {
              return typeof e4 == "function" && (ie("Setup custom " + t3 + "CalcMethod"), W[t3] = e4, e4 = "custom"), e4;
            }
            ...
            ce("margin", function(e3, t3) {
              t3.indexOf("-") !== -1 && (re("Negative CSS value ignored for " + e3), t3 = "");
              return t3;
            }("margin", u));
            ...
            return e3 === true && i === false ? (i = true, he()) : e3 === false && i === true && (i = false, de("remove"), s !== null && s.disconnect(), clearInterval(T)), Ne(0, 0, "autoResize", JSON.stringify(i)), i;
          }, close: function() {
            Ne(0, 0, "close");
          }, getId: function() {
            return I;
          }, getPageInfo: function(e3) {
            typeof e3 == "function" ? (H = e3, Ne(0, 0, "pageInfo")) : (H = function() {
            }, Ne(0, 0, "pageInfoStop"));
          ...
          } }, O === true && (o2("mouseenter", "Mouse Enter"), o2("mouseleave", "Mouse Leave")), he(), w = function() {
            function i2(e4) {
        ...
        function ue(e2) {
          ...
          t2.length === 2 && (this[t2 = "on" + t2[0].charAt(0).toUpperCase() + t2[0].slice(1)] = this[e2], delete this[e2], re("Deprecated: '" + e2 + "' has been renamed '" + t2 + "'. The old method will be removed in the next major version."));
        }
        function ce(e2, t2) {
          c !== t2 && t2 !== "" && t2 !== "null" && ie("Body " + e2 + ' set to "' + (document.body.style[e2] = t2) + '"');
        }
        function se(n2) {
        ...
        function he() {
          var e2;
          i === true ? (de("add"), e2 = b < 0, window.MutationObserver || window.WebKitMutationObserver ? e2 ? ge() : s = function() {
            function t2(e3) {
              function t3(e4) {
                e4.complete === false && (ie("Attach listeners to " + e4.src), e4.addEventListener("load", i2, false), e4.addEventListener("error", r2, false), u2.push(e4));
              }
              e3.type === "attributes" && e3.attributeName === "src" ? t3(e3.target) : e3.type === "childList" && Array.prototype.forEach.call(e3.target.querySelectorAll("img"), t3);
            }
            function o2(e3) {
            ...
            var u2 = [], c2 = window.MutationObserver || window.WebKitMutationObserver, s2 = function() {
              var e3 = document.querySelector("body");
              return s2 = new c2(a2), ie("Create body MutationObserver"), s2.observe(e3, { attributes: true, attributeOldValue: false, characterData: true, characterDataOldValue: false, childList: true, subtree: true }), s2;
            }();
            return { disconnect: function() {
              "disconnect" in s2 && (ie("Disconnect body MutationObserver"), s2.disconnect(), u2.forEach(o2));
            } };
          }() : (ie("MutationObserver not supported in this browser!"), ge())) : ie("Auto Resize disabled");
        }
        function ge() {
          b !== 0 && (ie("setInterval: " + b + "ms"), T = setInterval(function() {
            Oe("interval", "setInterval: " + b);
          }, Math.abs(b)));
        }
        function pe(e2, t2) {
          var n2 = 0;
          return t2 = t2 || document.body, n2 = (n2 = document.defaultView.getComputedStyle(t2, null)) !== null ? n2[e2] : 0, parseInt(n2, o);
        }
        function ve(e2, t2) {
        ...
        function we(e2, t2) {
          ...
          return n2.length === 0 && (re("No tagged elements (" + t2 + ") found on page"), document.querySelectorAll("body *")), ve(e2, n2);
        }
        function be() {
        ...
        function Te(e2, t2, n2, o2) {
          ...
          r2 = c !== n2 ? n2 : Z[p](), a2 = c !== o2 ? o2 : $[P](), u2(g, r2) || l && u2(F, a2) || e2 === "init" ? (Se(), Ne(g = r2, F = a2, e2)) : i2();
        }
        function Ee() {
          G = Date.now(), Q = null, K = V.apply(X, Y), Q || (X = Y = null);
        }
        function Oe(e2, t2, n2, o2) {
          x && e2 in f ? ie("Trigger event cancelled: " + e2) : (e2 in { reset: 1, resetPage: 1, init: 1 } || ie("Trigger event: " + t2), (e2 === "init" ? Te : _)(e2, t2, n2, o2));
        }
        function Se() {
        ...
        function Ne(e2, t2, n2, o2, i2) {
          var r2;
          C === true && (c === i2 ? i2 = k : ie("Message targetOrigin: " + i2), ie("Sending message to host page (" + (r2 = I + ":" + (e2 + ":" + t2) + ":" + n2 + (c !== o2 ? ":" + o2 : "")) + ")"), z.postMessage(S + r2, i2));
        }
        function Ae() {
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  // <stdin>
  var import_resizeChild = __toESM(require_resizeChild());
  window.Alpine = module_default;
  window.ResizeChild = import_resizeChild.default;
